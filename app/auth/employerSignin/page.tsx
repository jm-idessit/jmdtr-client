                    ...
                    <Card className="border-2">
                        <CardContent className="p-6 md:p-8">
                            ...
                            <div className="flex justify-center items-center gap-2 mb-6">
                                <div className="w-10 h-10 bg-linear-to-br from-emerald-600 to-purple-600 rounded-lg flex items-center justify-center">
                            ...
                            <div className="flex justify-center items-center text-center">
                                <div className="mb-8">
                                    <h1 className="text-3xl font-bold mb-2">Employer Sign In</h1>
                            ...
                            <div className="mt-6 text-center">
                                <p className="text-gray-600">
                                    ...
                                    <Link href="/auth/employerSignup" className="text-blue-600 hover:text-blue-700 font-semibold">
                                        Sign Up
                                    </Link>
                                </p>
                            </div>
            ...
            <div className="hidden lg:flex flex-1 bg-linear-to-br from-emerald-600 via-purple-600 to-blue-700 items-center justify-center p-8">
                <div className="max-w-md text-white">
                    <div className="mb-8">
                        ...
                        <h2 className="text-4xl font-bold mb-4">Manage Your Team Efficiently</h2>
                        <p className="text-lg opacity-90 mb-8">
                            Access your employer dashboard to track attendance, approve leave requests, and generate comprehensive reports.
                        </p>
                    </div>
